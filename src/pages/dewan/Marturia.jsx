...
export default function DewanMarturia() {
  ...
  const sections = useMemo(() => ([
    {
      title: "Zending",
      members: [
        { name: "Agus Prawiro", role: "Ketua", phone: "0813-1122-3344", wijk: "Wijk 7", photo: "https://placehold.co/400x400/a7f3d0/047857?text=AP", period: "01 Feb 2024 - 31 Jan 2027" },
        { name: "Bella Simanjuntak", role: "Anggota", phone: "0813-2233-4455", wijk: "Wijk 8", photo: "https://placehold.co/400x400/a7f3d0/047857?text=BS", period: "01 Feb 2024 - 31 Jan 2027" },
      ],
    },
    { title: "Musik", members: [] },
    { title: "Multimedia", members: [] },
    { title: "Koor Gabungan", members: [] },
  ]), []);
  ...
  return (
    <main>
      <section className="relative h-80 bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/1920x1080/34d399/ffffff?text=Dewan+Marturia')" }}>
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-5xl md:text-7xl font-bold font-serif">Dewan Marturia</h1>
            <p className="mt-4 text-lg">Memberitakan Injil dan Kesaksian Iman</p>
          </div>
        </div>
      </section>
