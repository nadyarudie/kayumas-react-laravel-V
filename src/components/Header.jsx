            ...
            <nav className="hidden lg:flex items-center space-x-6 text-xs font-semibold tracking-wider ml-auto">
              ...
              <div className="relative group">
                ...
                <ul className="absolute left-0 top-full pt-2 hidden group-hover:block group-focus-within:block z-50">
                  ...
                  <li><Link to="/jemaat-sakit" className="block w-56 bg-primary hover:bg-blue-900 px-4 py-2 shadow-xl">Jemaat Sakit</Link></li>
                  <li><Link to="/jemaat-meninggal" className="block w-56 bg-primary hover:bg-blue-900 px-4 py-2 rounded-b-md shadow-xl">Jemaat Meninggal</Link></li>
                </ul>
              </div>

              <Link to="/wijk" className="nav-link">INFO WIJK</Link>
